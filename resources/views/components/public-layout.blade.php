                ...
                <div class="max-w-7xl mx-auto px-4 grid grid-cols-1 md:grid-cols-3 gap-8 text-center md:text-left">
                    ...
                    <div>
                        ...
                        <div class="flex justify-center md:justify-start gap-4 mt-4">
                            <!-- WhatsApp -->
                            <a href="https://wa.me/601165019369" target="_blank" title="WhatsApp" class="text-gray-300 hover:text-[#25D366] transition">
                            ...
                            <!-- Instagram -->
                            <a href="https://www.instagram.com/axiyz.3d.studios/" target="_blank" title="Instagram" class="text-gray-300 hover:text-pink-400 transition">
                            ...
                            <!-- TikTok -->
                            <a href="https://www.tiktok.com/@axiyz.3d.studios" target="_blank" title="TikTok" class="text-gray-300 hover:text-white transition">
                            ...
                            <!-- Email -->
                            <a href="mailto:axiyz3d@gmail.com" title="Email" class="text-gray-300 hover:text-brand-yellow transition">
                    ...
                    <div>
                        ...
                        <ul class="space-y-2 text-gray-300">
                            ...
                            <li class="flex items-center justify-center md:justify-start gap-2">
                                ...
                                <a href="https://maps.app.goo.gl/PhfnQpA9QRQHu6Q49" target="_blank" class="hover:text-white transition">View on Google Maps</a>
                            </li>
                        </ul>
                    </div>
                </div>
